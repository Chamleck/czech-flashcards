...
export type Screen = "home" | "words" | "grammar";

interface Tile {
  key: Screen | "phrases" | "sentences";
  emoji: string;
  title: string;
  subtitle: string;
  color: string;
...
const TILES: Tile[] = [
  ...
  { key: "grammar", emoji: "📚", title: "Граматика", subtitle: "Відмінки та зразки", color: theme.colors.lilac, ready: true },
        ...
        <View style={styles.grid}>
          {TILES.map((t) => (
            <Pressable
              ...
              onPress={() => t.ready && onOpen(t.key as Screen)}
            >
...
const styles = StyleSheet.create({
  ...
  hi: { color: theme.colors.text, fontSize: 34, fontWeight: "900", marginTop: theme.space(4) },
