...
// (шапка випускника, speechBalloon), High Contrast вирішував контраст, але
...
// - bullseye, writingHand, scroll: жодного темного тону в палітрі —
//   scroll узагалі без жодного stroke-фіксу (на відміну від шапки
//   випускника, яку він замінив: та була темна навіть у Twemoji, обов'язково
//   потрібен був stroke по контуру; пергамент scroll — світлий сам по собі).
