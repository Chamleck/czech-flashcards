...
export const VERBS: VerbEntry[] = [
  ...
  // ═══════════════════ Батч розширення словника (7 пар, за частотністю) ═══════════════════
  // Джерела: prirucka.ujc.cas.cz, dobryslovnik.cz (наказовий спосіб звірено ЯВНО для
  // КОЖНОГО дієслова — урок з uvidět/uslyšet: рідковживаність ≠ відсутність форми).
  {
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "říkám", ty: "říkáš", on: "říká", my: "říkáme", vy: "říkáte", oni: "říkají" },
    pastParticiple: { m: "říkal", f: "říkala", n: "říkalo", manim_pl: "říkali", other_pl: "říkaly" },
    imperative: { ty: "říkej", vy: "říkejte", my: "říkejme" },
    aspectPairNote: "доконаний партнер: říct (сказати)",
    aspectPairId: "rict",
    examples: {
      present: { cz: "Říkám pravdu.", uk: "Я кажу правду." },
      past: { cz: "Říkal jsem pravdu.", uk: "Я казав правду." },
      future: { cz: "Budu říkat pravdu.", uk: "Я казатиму правду." },
      imperative: { cz: "Říkej pravdu!", uk: "Кажи правду!" },
    },
  },
  {
    id: "rict",
    ...
    examples: {
      ...
      future: { cz: "Řeknu ti pravdu.", uk: "Я скажу тобі правду." },
      imperative: { cz: "Řekni mi to!", uk: "Скажи мені це!" },
    },
  },
  {
    id: "davat",
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "dávám", ty: "dáváš", on: "dává", my: "dáváme", vy: "dáváte", oni: "dávají" },
    pastParticiple: { m: "dával", f: "dávala", n: "dávalo", manim_pl: "dávali", other_pl: "dávaly" },
    imperative: { ty: "dávej", vy: "dávejte", my: "dávejme" },
    aspectPairNote: "доконаний партнер: dát (дати)",
    aspectPairId: "dat",
    examples: {
      present: { cz: "Dávám ti kávu.", uk: "Я даю тобі каву." },
      past: { cz: "Dával jsem ti kávu.", uk: "Я давав тобі каву." },
      future: { cz: "Budu ti dávat kávu.", uk: "Я даватиму тобі каву." },
      imperative: { cz: "Dávej mi kávu ráno!", uk: "Давай мені каву вранці!" },
    },
  },
  {
    id: "dat",
    ...
    aspect: "perfective",
    verbClass: "irregular",
    future: { ja: "dám", ty: "dáš", on: "dá", my: "dáme", vy: "dáte", oni: "dají" },
    pastParticiple: { m: "dal", f: "dala", n: "dalo", manim_pl: "dali", other_pl: "daly" },
    imperative: { ty: "dej", vy: "dejte", my: "dejme" },
    aspectPairNote: "недоконаний партнер: dávat (давати); нерегулярна парадигма (як jíst/vědět)",
    aspectPairId: "davat",
    examples: {
      past: { cz: "Dal jsem ti kávu.", uk: "Я дав тобі каву." },
      future: { cz: "Dám ti kávu.", uk: "Я дам тобі каву." },
      imperative: { cz: "Dej mi kávu!", uk: "Дай мені каву!" },
    },
  },
  {
    id: "nachazet",
    ...
    examples: {
      ...
      future: { cz: "Budu nacházet řešení.", uk: "Я знаходитиму рішення." },
      imperative: { cz: "Nacházej v tom smysl!", uk: "Знаходь у цьому сенс!" },
    },
  },
  {
    id: "najit",
    ...
    aspect: "perfective",
    verbClass: "I",
    future: { ja: "najdu", ty: "najdeš", on: "najde", my: "najdeme", vy: "najdete", oni: "najdou" },
    pastParticiple: { m: "našel", f: "našla", n: "našlo", manim_pl: "našli", other_pl: "našly" },
    imperative: { ty: "najdi", vy: "najděte", my: "najděme" },
    aspectPairNote: "недоконаний партнер: nacházet (знаходити)",
    aspectPairId: "nachazet",
    examples: {
      past: { cz: "Našel jsem klíče.", uk: "Я знайшов ключі." },
      future: { cz: "Najdu řešení.", uk: "Я знайду рішення." },
      imperative: { cz: "Najdi ten klíč!", uk: "Знайди той ключ!" },
    },
  },
  {
    id: "pomahat",
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "pomáhám", ty: "pomáháš", on: "pomáhá", my: "pomáháme", vy: "pomáháte", oni: "pomáhají" },
    pastParticiple: { m: "pomáhal", f: "pomáhala", n: "pomáhalo", manim_pl: "pomáhali", other_pl: "pomáhaly" },
    imperative: { ty: "pomáhej", vy: "pomáhejte", my: "pomáhejme" },
    aspectPairNote: "доконаний партнер: pomoct (допомогти)",
    aspectPairId: "pomoct",
    examples: {
      present: { cz: "Pomáhám mamince.", uk: "Я допомагаю мамі." },
      past: { cz: "Pomáhal jsem mamince.", uk: "Я допомагав мамі." },
      future: { cz: "Budu ti pomáhat.", uk: "Я допомагатиму тобі." },
      imperative: { cz: "Pomáhej chudým lidem!", uk: "Допомагай бідним людям!" },
    },
  },
  {
    id: "pomoct",
    ...
    examples: {
      ...
      future: { cz: "Pomohu ti.", uk: "Я допоможу тобі." },
      imperative: { cz: "Pomoz mi, prosím!", uk: "Допоможи мені, будь ласка!" },
    },
  },
  {
    id: "oteviret",
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "otevírám", ty: "otevíráš", on: "otevírá", my: "otevíráme", vy: "otevíráte", oni: "otevírají" },
    pastParticiple: { m: "otevíral", f: "otevírala", n: "otevíralo", manim_pl: "otevírali", other_pl: "otevíraly" },
    ...
    examples: {
      ...
      future: { cz: "Budu otevírat obchod v osm.", uk: "Я відкриватиму магазин о восьмій." },
      imperative: { cz: "Otevírej oči!", uk: "Відкривай очі!" },
    },
  },
  {
    id: "otevrit",
    ...
    aspect: "perfective",
    verbClass: "I",
    future: { ja: "otevřu", ty: "otevřeš", on: "otevře", my: "otevřeme", vy: "otevřete", oni: "otevřou" },
    pastParticiple: { m: "otevřel", f: "otevřela", n: "otevřelo", manim_pl: "otevřeli", other_pl: "otevřely" },
    imperative: { ty: "otevři", vy: "otevřete", my: "otevřeme" },
    aspectPairNote: "недоконаний партнер: otevírat (відкривати)",
    aspectPairId: "oteviret",
    examples: {
      past: { cz: "Otevřel jsem dveře.", uk: "Я відкрив двері." },
      future: { cz: "Otevřu dveře.", uk: "Я відкрию двері." },
      imperative: { cz: "Otevři okno!", uk: "Відкрий вікно!" },
    },
  },
  {
    id: "zaviret",
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "zavírám", ty: "zaviráš", on: "zavírá", my: "zavíráme", vy: "zaviráte", oni: "zavírají" },
    pastParticiple: { m: "zavíral", f: "zavírala", n: "zavíralo", manim_pl: "zavírali", other_pl: "zavíraly" },
    ...
    examples: {
      ...
      future: { cz: "Budu zavírat okna.", uk: "Я закриватиму вікна." },
      imperative: { cz: "Zavírej dveře!", uk: "Закривай двері!" },
    },
  },
  {
    id: "zavrit",
    ...
    aspect: "perfective",
    verbClass: "I",
    future: { ja: "zavřu", ty: "zavřeš", on: "zavře", my: "zavřeme", vy: "zavřete", oni: "zavřou" },
    pastParticiple: { m: "zavřel", f: "zavřela", n: "zavřelo", manim_pl: "zavřeli", other_pl: "zavřely" },
    imperative: { ty: "zavři", vy: "zavřete", my: "zavřeme" },
    aspectPairNote: "недоконаний партнер: zavírat (закривати)",
    aspectPairId: "zaviret",
    examples: {
      past: { cz: "Zavřel jsem okno.", uk: "Я закрив вікно." },
      future: { cz: "Zavřu okno.", uk: "Я закрию вікно." },
      imperative: { cz: "Zavři dveře!", uk: "Закрий двері!" },
    },
  },
  {
    id: "rozumet",
    ...
    examples: {
      ...
      past: { cz: "Rozuměl jsem ti.", uk: "Я розумів тебе." },
      future: { cz: "Budu ti rozumět.", uk: "Я розумітиму тебе." },
      imperative: { cz: "Rozuměj mi, prosím.", uk: "Розумій мене, будь ласка." },
    },
  },
  {
    id: "porozumet",
    ...
    aspect: "perfective",
    verbClass: "IV",
    future: { ja: "porozumím", ty: "porozumíš", on: "porozumí", my: "porozumíme", vy: "porozumíte", oni: "porozumějí" },
    pastParticiple: { m: "porozuměl", f: "porozuměla", n: "porozumělo", manim_pl: "porozuměli", other_pl: "porozuměly" },
    imperative: { ty: "porozuměj", vy: "porozumějte", my: "porozumějme" },
    aspectPairNote: "недоконаний партнер: rozumět (розуміти); значення трохи відрізняється — «дійти розуміння» проти «мати здатність розуміти»",
    aspectPairId: "rozumet",
    examples: {
      past: { cz: "Porozuměl jsem tomu.", uk: "Я зрозумів це." },
      future: { cz: "Porozumím tomu.", uk: "Я зрозумію це." },
      imperative: { cz: "Porozuměj mi!", uk: "Зрозумій мене!" },
    },
  },

  // ═══════════════════ Батч розширення словника #2 (5 пар + 3 самостійних) ═══════════════════
  // Джерела: prirucka.ujc.cas.cz, dobryslovnik.cz. líbit se — наказовий спосіб формально
  // існує (lib!), але вживається вкрай рідко (як і vypadat/bydlet — семантично специфічні
  // дієслова); rarity відзначена в примітці, форму НЕ пропущено (урок з uvidět/uslyšet).
  {
    ...
    examples: {
      ...
      past: { cz: "Ukazoval jsem ti obrázek.", uk: "Я показував тобі малюнок." },
      future: { cz: "Budu ti ukazovat obrázky.", uk: "Я показуватиму тобі малюнки." },
      imperative: { cz: "Ukazuj mi to!", uk: "Показуй мені це!" },
    },
  },
  {
    id: "ukazat",
    ...
    aspect: "perfective",
    verbClass: "I",
    future: { ja: "ukážu", ty: "ukážeš", on: "ukáže", my: "ukážeme", vy: "ukážete", oni: "ukážou" },
    pastParticiple: { m: "ukázal", f: "ukázala", n: "ukázalo", manim_pl: "ukázali", other_pl: "ukázaly" },
    imperative: { ty: "ukaž", vy: "ukažte", my: "ukažme" },
    aspectPairNote: "недоконаний партнер: ukazovat (показувати)",
    aspectPairId: "ukazovat",
    examples: {
      past: { cz: "Ukázal jsem ti obrázek.", uk: "Я показав тобі малюнок." },
      future: { cz: "Ukážu ti obrázek.", uk: "Я покажу тобі малюнок." },
      imperative: { cz: "Ukaž mi to!", uk: "Покажи мені це!" },
    },
  },
  {
    id: "zkouset",
    ...
    aspect: "imperfective",
    verbClass: "IV",
    present: { ja: "zkouším", ty: "zkoušíš", on: "zkouší", my: "zkoušíme", vy: "zkoušíte", oni: "zkoušejí" },
    pastParticiple: { m: "zkoušel", f: "zkoušela", n: "zkoušelo", manim_pl: "zkoušeli", other_pl: "zkoušely" },
    imperative: { ty: "zkoušej", vy: "zkoušejte", my: "zkoušejme" },
    aspectPairNote: "доконаний партнер: zkusit (спробувати)",
    aspectPairId: "zkusit",
    examples: {
      present: { cz: "Zkouším novou kávu.", uk: "Я пробую нову каву." },
      past: { cz: "Zkoušel jsem novou kávu.", uk: "Я пробував нову каву." },
      future: { cz: "Budu zkoušet novou kávu.", uk: "Я пробуватиму нову каву." },
      imperative: { cz: "Zkoušej to znovu!", uk: "Пробуй це знову!" },
    },
  },
  {
    id: "zkusit",
    ...
    aspect: "perfective",
    verbClass: "IV",
    future: { ja: "zkusím", ty: "zkusíš", on: "zkusí", my: "zkusíme", vy: "zkusíte", oni: "zkusí" },
    pastParticiple: { m: "zkusil", f: "zkusila", n: "zkusilo", manim_pl: "zkusili", other_pl: "zkusily" },
    imperative: { ty: "zkus", vy: "zkuste", my: "zkusme" },
    aspectPairNote: "недоконаний партнер: zkoušet (пробувати)",
    aspectPairId: "zkouset",
    examples: {
      past: { cz: "Zkusil jsem novou kávu.", uk: "Я спробував нову каву." },
      future: { cz: "Zkusím novou kávu.", uk: "Я спробую нову каву." },
      imperative: { cz: "Zkus to!", uk: "Спробуй це!" },
    },
  },
  {
    id: "poznavat",
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "poznávám", ty: "poznáváš", on: "poznává", my: "poznáváme", vy: "poznáváte", oni: "poznávají" },
    pastParticiple: { m: "poznával", f: "poznávala", n: "poznávalo", manim_pl: "poznávali", other_pl: "poznávaly" },
    imperative: { ty: "poznávej", vy: "poznávejte", my: "poznávejme" },
    aspectPairNote: "доконаний партнер: poznat (впізнати, познайомитися)",
    aspectPairId: "poznat",
    examples: {
      present: { cz: "Poznávám nového kolegu.", uk: "Я знайомлюся з новим колегою." },
      past: { cz: "Poznával jsem nového kolegu.", uk: "Я знайомився з новим колегою." },
      future: { cz: "Budu poznávat nové lidi.", uk: "Я знайомитимусь з новими людьми." },
      imperative: { cz: "Poznávej svět!", uk: "Пізнавай світ!" },
    },
  },
  {
    id: "poznat",
    ...
    examples: {
      ...
      future: { cz: "Poznám nového kolegu.", uk: "Я познайомлюся з новим колегою." },
      imperative: { cz: "Poznej ho blíž!", uk: "Пізнай його краще!" },
    },
  },
  {
    id: "potkavat",
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "potkávám", ty: "potkáváš", on: "potkává", my: "potkáváme", vy: "potkáváte", oni: "potkávají" },
    pastParticiple: { m: "potkával", f: "potkávala", n: "potkávalo", manim_pl: "potkávali", other_pl: "potkávaly" },
    ...
    examples: {
      ...
      future: { cz: "Budu ho tam potkávat.", uk: "Я його там зустрічатиму." },
      imperative: { cz: "Potkávej ho každý den!", uk: "Зустрічай його щодня!" },
    },
  },
  {
    id: "potkat",
    ...
    aspect: "perfective",
    verbClass: "V",
    future: { ja: "potkám", ty: "potkáš", on: "potká", my: "potkáme", vy: "potkáte", oni: "potkají" },
    pastParticiple: { m: "potkal", f: "potkala", n: "potkalo", manim_pl: "potkali", other_pl: "potkaly" },
    imperative: { ty: "potkej", vy: "potkejte", my: "potkejme" },
    aspectPairNote: "недоконаний партнер: potkávat (зустрічати)",
    aspectPairId: "potkavat",
    examples: {
      past: { cz: "Potkal jsem kamaráda.", uk: "Я зустрів друга." },
      future: { cz: "Potkám tě zítra.", uk: "Я зустріну тебе завтра." },
      imperative: { cz: "Potkej mě tam!", uk: "Зустрінь мене там!" },
    },
  },
  {
    id: "koncit",
    ...
    aspect: "imperfective",
    verbClass: "IV",
    present: { ja: "končím", ty: "končíš", on: "končí", my: "končíme", vy: "končíte", oni: "končí" },
    pastParticiple: { m: "končil", f: "končila", n: "končilo", manim_pl: "končili", other_pl: "končily" },
    ...
    examples: {
      ...
      future: { cz: "Budu končit práci pozdě.", uk: "Я закінчуватиму роботу пізно." },
      imperative: { cz: "Konči práci!", uk: "Закінчуй роботу!" },
    },
  },
  {
    id: "skoncit",
    ...
    aspect: "perfective",
    verbClass: "IV",
    future: { ja: "skončím", ty: "skončíš", on: "skončí", my: "skončíme", vy: "skončíte", oni: "skončí" },
    pastParticiple: { m: "skončil", f: "skončila", n: "skončilo", manim_pl: "skončili", other_pl: "skončily" },
    imperative: { ty: "skonči", vy: "skončete", my: "skončeme" },
    aspectPairNote: "недоконаний партнер: končit (закінчувати)",
    aspectPairId: "koncit",
    examples: {
      past: { cz: "Skončil jsem práci v pět.", uk: "Я закінчив роботу о п'ятій." },
      future: { cz: "Skončím práci v pět.", uk: "Я закінчу роботу о п'ятій." },
      imperative: { cz: "Skonči tu práci!", uk: "Закінчи цю роботу!" },
    },
  },
  {
    id: "vypadat",
    uk: "виглядати (мати вигляд)",
    cz: "vypadat",
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "vypadám", ty: "vypadáš", on: "vypadá", my: "vypadáme", vy: "vypadáte", oni: "vypadají" },
    pastParticiple: { m: "vypadal", f: "vypadala", n: "vypadalo", manim_pl: "vypadali", other_pl: "vypadaly" },
    imperative: { ty: "vypadej", vy: "vypadejte", my: "vypadejme" },
    aspectPairNote: "самостійне (без пари); наказовий спосіб рідковживаний — рідко «наказують» виглядати якось",
    examples: {
      present: { cz: "Vypadáš dobře.", uk: "Ти добре виглядаєш." },
      past: { cz: "Vypadal jsi unaveně.", uk: "Ти виглядав втомленим." },
      future: { cz: "Budeš vypadat lépe.", uk: "Ти виглядатимеш краще." },
      imperative: { cz: "Vypadej profesionálně!", uk: "Виглядай професійно!" },
    },
  },
  {
    id: "bydlet",
    ...
    examples: {
      ...
      future: { cz: "Budu bydlet v Praze.", uk: "Я житиму в Празі." },
      imperative: { cz: "Bydli tady se mnou!", uk: "Живи тут зі мною!" },
    },
  },
  {
    id: "libit-se",
    ...
    verbClass: "IV",
    reflexive: "se",
    present: { ja: "líbím", ty: "líbíš", on: "líbí", my: "líbíme", vy: "líbíte", oni: "líbí" },
    pastParticiple: { m: "líbil", f: "líbila", n: "líbilo", manim_pl: "líbili", other_pl: "líbily" },
    imperative: { ty: "lib se", vy: "libte se", my: "libme se" },
    aspectPairNote: "самостійне (без пари); вживається майже виключно у 3-й особі (líbí se mi = мені подобається); наказовий спосіб формально існує, але вкрай рідковживаний",
    examples: {
      present: { cz: "Líbí se mi ten film.", uk: "Мені подобається цей фільм." },
      past: { cz: "Ten film se mi líbil.", uk: "Цей фільм мені сподобався." },
      future: { cz: "Bude se ti to líbit.", uk: "Тобі це сподобається." },
      imperative: { cz: "Lib se mi!", uk: "Подобайся мені!" },
    },
  },

  // ═══════════════════ Батч розширення словника #3 (5 пар + 3 самостійних) ═══════════════════
  // Джерела: prirucka.ujc.cas.cz, dobryslovnik.cz. dostat/rozhodnout se звірено ПРЯМИМ
  // структурним прецедентом у самій базі (vstát→vstaň, sednout→sedni), а не лише зовнішнім
  // пошуком — той самий корінь-тип. vadit/stačit спершу виглядали як можливі винятки
  // (як líbit se) — обидва РЕАЛЬНО атестовані (vaď!/stač!), перевірено явно, не припущено.
  {
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "dostávám", ty: "dostáváš", on: "dostává", my: "dostáváme", vy: "dostáváte", oni: "dostávají" },
    pastParticiple: { m: "dostával", f: "dostávala", n: "dostávalo", manim_pl: "dostávali", other_pl: "dostávaly" },
    ...
    examples: {
      ...
      future: { cz: "Budu dostávat dopisy.", uk: "Я отримуватиму листи." },
      imperative: { cz: "Dostávej dobré známky!", uk: "Отримуй гарні оцінки!" },
    },
  },
  {
    id: "dostat",
    ...
    aspect: "perfective",
    verbClass: "II",
    future: { ja: "dostanu", ty: "dostaneš", on: "dostane", my: "dostaneme", vy: "dostanete", oni: "dostanou" },
    pastParticiple: { m: "dostal", f: "dostala", n: "dostalo", manim_pl: "dostali", other_pl: "dostaly" },
    imperative: { ty: "dostaň", vy: "dostaňte", my: "dostaňme" },
    aspectPairNote: "недоконаний партнер: dostávat (отримувати); той самий тип, що vstát→vstaň",
    aspectPairId: "dostavat",
    examples: {
      past: { cz: "Dostal jsem dárek.", uk: "Я отримав подарунок." },
      future: { cz: "Dostanu dárek.", uk: "Я отримаю подарунок." },
      imperative: { cz: "Dostaň ode mě dárek!", uk: "Отримай від мене подарунок!" },
    },
  },
  {
    id: "posilat",
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "posílám", ty: "posíláš", on: "posílá", my: "posíláme", vy: "posíláte", oni: "posílají" },
    pastParticiple: { m: "posílal", f: "posílala", n: "posílalo", manim_pl: "posílali", other_pl: "posílaly" },
    imperative: { ty: "posílej", vy: "posílejte", my: "posílejme" },
    aspectPairNote: "доконаний партнер: poslat (надіслати)",
    aspectPairId: "poslat",
    examples: {
      present: { cz: "Posílám ti dopis.", uk: "Я надсилаю тобі листа." },
      past: { cz: "Posílal jsem ti dopis.", uk: "Я надсилав тобі листа." },
      future: { cz: "Budu ti posílat dopisy.", uk: "Я надсилатиму тобі листи." },
      imperative: { cz: "Posílej mi dopisy!", uk: "Надсилай мені листи!" },
    },
  },
  {
    id: "poslat",
    ...
    aspect: "perfective",
    verbClass: "I",
    future: { ja: "pošlu", ty: "pošleš", on: "pošle", my: "pošleme", vy: "pošlete", oni: "pošlou" },
    pastParticiple: { m: "poslal", f: "poslala", n: "poslalo", manim_pl: "poslali", other_pl: "poslaly" },
    imperative: { ty: "pošli", vy: "pošlete", my: "pošleme" },
    aspectPairNote: "недоконаний партнер: posílat (надсилати)",
    aspectPairId: "posilat",
    examples: {
      past: { cz: "Poslal jsem ti dopis.", uk: "Я надіслав тобі листа." },
      future: { cz: "Pošlu ti dopis.", uk: "Я надішлю тобі листа." },
      imperative: { cz: "Pošli mi to!", uk: "Надішли мені це!" },
    },
  },
  {
    id: "rozhodovat-se",
    ...
    examples: {
      present: { cz: "Rozhoduju se rychle.", uk: "Я вирішую швидко." },
      past: { cz: "Rozhodoval jsem se dlouho.", uk: "Я вирішував довго." },
      future: { cz: "Budu se rozhodovat pomalu.", uk: "Я вирішуватиму повільно." },
      imperative: { cz: "Rozhoduj se rychle!", uk: "Вирішуй швидко!" },
    },
  },
  {
    id: "rozhodnout-se",
    ...
    verbClass: "II",
    reflexive: "se",
    future: { ja: "rozhodnu", ty: "rozhodneš", on: "rozhodne", my: "rozhodneme", vy: "rozhodnete", oni: "rozhodnou" },
    pastParticiple: { m: "rozhodl", f: "rozhodla", n: "rozhodlo", manim_pl: "rozhodli", other_pl: "rozhodly" },
    imperative: { ty: "rozhodni se", vy: "rozhodněte se", my: "rozhodněme se" },
    aspectPairNote: "недоконаний партнер: rozhodovat se (вирішувати); той самий тип, що sednout si→sedni si",
    aspectPairId: "rozhodovat-se",
    examples: {
      past: { cz: "Rozhodl jsem se odejít.", uk: "Я вирішив піти." },
      future: { cz: "Rozhodnu se zítra.", uk: "Я вирішу завтра." },
      imperative: { cz: "Rozhodni se konečně!", uk: "Вирішуй уже!" },
    },
  },
  {
    id: "omlouvat-se",
    ...
    verbClass: "V",
    reflexive: "se",
    present: { ja: "omlouvám", ty: "omlouváš", on: "omlouvá", my: "omlouváme", vy: "omlouváte", oni: "omlouvají" },
    pastParticiple: { m: "omlouval", f: "omlouvala", n: "omlouvalo", manim_pl: "omlouvali", other_pl: "omlouvaly" },
    imperative: { ty: "omlouvej se", vy: "omlouvejte se", my: "omlouvejme se" },
    aspectPairNote: "доконаний партнер: omluvit se (вибачитися)",
    aspectPairId: "omluvit-se",
    examples: {
      present: { cz: "Omlouvám se za zpoždění.", uk: "Я вибачаюся за запізнення." },
      past: { cz: "Omlouval jsem se za zpoždění.", uk: "Я вибачався за запізнення." },
      future: { cz: "Budu se omlouvat za zpoždění.", uk: "Я вибачатимусь за запізнення." },
      imperative: { cz: "Omlouvej se hned!", uk: "Вибачайся негайно!" },
    },
  },
  {
    id: "omluvit-se",
    ...
    verbClass: "IV",
    reflexive: "se",
    future: { ja: "omluvím", ty: "omluvíš", on: "omluví", my: "omluvíme", vy: "omluvíte", oni: "omluví" },
    pastParticiple: { m: "omluvil", f: "omluvila", n: "omluvilo", manim_pl: "omluvili", other_pl: "omluvily" },
    imperative: { ty: "omluv se", vy: "omluvte se", my: "omluvme se" },
    aspectPairNote: "недоконаний партнер: omlouvat se (вибачатися); той самий тип, що mluvit→mluv",
    aspectPairId: "omlouvat-se",
    examples: {
      past: { cz: "Omluvil jsem se za zpoždění.", uk: "Я вибачився за запізнення." },
      future: { cz: "Omluvím se za zpoždění.", uk: "Я вибачуся за запізнення." },
      imperative: { cz: "Omluv se mu!", uk: "Вибачся перед ним!" },
    },
  },
  {
    id: "citit",
    ...
    aspect: "imperfective",
    verbClass: "IV",
    present: { ja: "cítím", ty: "cítíš", on: "cítí", my: "cítíme", vy: "cítíte", oni: "cítí" },
    pastParticiple: { m: "cítil", f: "cítila", n: "cítilo", manim_pl: "cítili", other_pl: "cítily" },
    imperative: { ty: "ciť", vy: "ciťte", my: "ciťme" },
    aspectPairNote: "доконаний партнер: ucítit (відчути)",
    aspectPairId: "ucitit",
    examples: {
      present: { cz: "Cítím radost.", uk: "Я відчуваю радість." },
      past: { cz: "Cítil jsem radost.", uk: "Я відчував радість." },
      future: { cz: "Budu cítit radost.", uk: "Я відчуватиму радість." },
      imperative: { cz: "Ciť tu radost!", uk: "Відчувай цю радість!" },
    },
  },
  {
    id: "ucitit",
    ...
    aspect: "perfective",
    verbClass: "IV",
    future: { ja: "ucítím", ty: "ucítíš", on: "ucítí", my: "ucítíme", vy: "ucítíte", oni: "ucítí" },
    pastParticiple: { m: "ucítil", f: "ucítila", n: "ucítilo", manim_pl: "ucítili", other_pl: "ucítily" },
    imperative: { ty: "uciť", vy: "uciťte", my: "uciťme" },
    aspectPairNote: "недоконаний партнер: cítit (відчувати)",
    aspectPairId: "citit",
    examples: {
      past: { cz: "Ucítil jsem změnu.", uk: "Я відчув зміну." },
      future: { cz: "Ucítím tu změnu.", uk: "Я відчую цю зміну." },
      imperative: { cz: "Uciť tu změnu!", uk: "Відчуй цю зміну!" },
    },
  },
  {
    id: "hledat",
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "hledám", ty: "hledáš", on: "hledá", my: "hledáme", vy: "hledáte", oni: "hledají" },
    pastParticiple: { m: "hledal", f: "hledala", n: "hledalo", manim_pl: "hledali", other_pl: "hledaly" },
    imperative: { ty: "hledej", vy: "hledejte", my: "hledejme" },
    aspectPairNote: "самостійне (без пари); найт → знайти (najít) вже в парі з nacházet",
    examples: {
      present: { cz: "Hledám práci.", uk: "Я шукаю роботу." },
      past: { cz: "Hledal jsem práci.", uk: "Я шукав роботу." },
      future: { cz: "Budu hledat práci.", uk: "Я шукатиму роботу." },
      imperative: { cz: "Hledej dál!", uk: "Шукай далі!" },
    },
  },
  {
    id: "vadit",
    ...
    aspect: "imperfective",
    verbClass: "IV",
    present: { ja: "vadím", ty: "vadíš", on: "vadí", my: "vadíme", vy: "vadíte", oni: "vadí" },
    pastParticiple: { m: "vadil", f: "vadila", n: "vadilo", manim_pl: "vadili", other_pl: "vadily" },
    imperative: { ty: "vaď", vy: "vaďte", my: "vaďme" },
    aspectPairNote: "самостійне (без пари); найчастіше вживається безособово (nevadí mi = мені не заважає); наказовий спосіб рідковживаний",
    examples: {
      present: { cz: "Nevadí mi to.", uk: "Мені це не заважає." },
      past: { cz: "Nevadilo mi to.", uk: "Мені це не заважало." },
      future: { cz: "Nebude mi to vadit.", uk: "Мені це не заважатиме." },
      imperative: { cz: "Vaď mu trochu!", uk: "Заважай йому трохи!" },
    },
  },
  {
    id: "stacit",
    uk: "бути достатнім (вистачати)",
    cz: "stačit",
    aspect: "imperfective",
    verbClass: "IV",
    present: { ja: "stačím", ty: "stačíš", on: "stačí", my: "stačíme", vy: "stačíte", oni: "stačí" },
    pastParticiple: { m: "stačil", f: "stačila", n: "stačilo", manim_pl: "stačili", other_pl: "stačily" },
    imperative: { ty: "stač", vy: "stačte", my: "stačme" },
    aspectPairNote: "самостійне (без пари); майже завжди вживається у 3-й особі (to stačí = цього достатньо); наказовий спосіб рідковживаний",
    examples: {
      present: { cz: "To stačí.", uk: "Цього достатньо." },
      past: { cz: "To stačilo.", uk: "Цього було достатньо." },
      future: { cz: "To bude stačit.", uk: "Цього буде достатньо." },
      imperative: { cz: "Stač mi na dnešek!", uk: "Будь мені достатнім на сьогодні!" },
    },
  },
  ...
  // ОБИДВА окремо, не екстрапольовано з одного на інше.
  {
    ...
    aspect: "imperfective",
    verbClass: "IV",
    present: { ja: "vařím", ty: "vaříš", on: "vaří", my: "vaříme", vy: "vaříte", oni: "vaří" },
    pastParticiple: { m: "vařil", f: "vařila", n: "vařilo", manim_pl: "vařili", other_pl: "vařily" },
    imperative: { ty: "vař", vy: "vařte", my: "vařme" },
    aspectPairNote: "доконаний партнер: uvařit (зварити)",
    aspectPairId: "uvarit",
    examples: {
      present: { cz: "Vařím oběd.", uk: "Я варю обід." },
      past: { cz: "Vařil jsem oběd.", uk: "Я варив обід." },
      future: { cz: "Budu vařit oběd.", uk: "Я варитиму обід." },
      imperative: { cz: "Vař oběd!", uk: "Вари обід!" },
    },
  },
  {
    id: "uvarit",
    ...
    aspect: "perfective",
    verbClass: "IV",
    future: { ja: "uvařím", ty: "uvaříš", on: "uvaří", my: "uvaříme", vy: "uvaříte", oni: "uvaří" },
    pastParticiple: { m: "uvařil", f: "uvařila", n: "uvařilo", manim_pl: "uvařili", other_pl: "uvařily" },
    imperative: { ty: "uvař", vy: "uvařte", my: "uvařme" },
    aspectPairNote: "недоконаний партнер: vařit (варити)",
    aspectPairId: "varit",
    examples: {
      past: { cz: "Uvařil jsem oběd.", uk: "Я зварив обід." },
      future: { cz: "Uvařím oběd.", uk: "Я зварю обід." },
      imperative: { cz: "Uvař mi kávu!", uk: "Звари мені каву!" },
    },
  },
  {
    id: "prichazet",
    ...
    aspect: "imperfective",
    verbClass: "IV",
    present: { ja: "přicházím", ty: "přicházíš", on: "přichází", my: "přicházíme", vy: "přicházíte", oni: "přicházejí" },
    pastParticiple: { m: "přicházel", f: "přicházela", n: "přicházelo", manim_pl: "přicházeli", other_pl: "přicházely" },
    ...
    examples: {
      ...
      future: { cz: "Budu přicházet pozdě.", uk: "Я приходитиму пізно." },
      imperative: { cz: "Přicházej včas!", uk: "Приходь вчасно!" },
    },
  },
  {
    id: "prijit",
    ...
    aspect: "perfective",
    verbClass: "I",
    future: { ja: "přijdu", ty: "přijdeš", on: "přijde", my: "přijdeme", vy: "přijdete", oni: "přijdou" },
    pastParticiple: { m: "přišel", f: "přišla", n: "přišlo", manim_pl: "přišli", other_pl: "přišly" },
    imperative: { ty: "přijď", vy: "přijďte", my: "přijďme" },
    aspectPairNote: "недоконаний партнер: přicházet (приходити); наказовий спосіб нерегулярний (přijď, НЕ přijdi — на відміну від najít→najdi)",
    aspectPairId: "prichazet",
    examples: {
      past: { cz: "Přišel jsem domů.", uk: "Я прийшов додому." },
      future: { cz: "Přijdu domů.", uk: "Я прийду додому." },
      imperative: { cz: "Přijď brzy!", uk: "Приходь швидко!" },
    },
  },
  {
    id: "odchazet",
    ...
    aspect: "imperfective",
    verbClass: "IV",
    present: { ja: "odcházím", ty: "odcházíš", on: "odchází", my: "odcházíme", vy: "odcházíte", oni: "odcházejí" },
    pastParticiple: { m: "odcházel", f: "odcházela", n: "odcházelo", manim_pl: "odcházeli", other_pl: "odcházely" },
    ...
    examples: {
      ...
      future: { cz: "Budu odcházet brzy.", uk: "Я йтиму рано." },
      imperative: { cz: "Odcházej potichu!", uk: "Йди тихо!" },
    },
  },
  {
    id: "odejit",
    ...
    aspect: "perfective",
    verbClass: "I",
    future: { ja: "odejdu", ty: "odejdeš", on: "odejde", my: "odejdeme", vy: "odejdete", oni: "odejdou" },
    pastParticiple: { m: "odešel", f: "odešla", n: "odešlo", manim_pl: "odešli", other_pl: "odešly" },
    imperative: { ty: "odejdi", vy: "odejděte", my: "odejděme" },
    aspectPairNote: "недоконаний партнер: odcházet (відходити); наказовий спосіб РЕГУЛЯРНИЙ (odejdi — на відміну від přijít→přijď)",
    aspectPairId: "odchazet",
    examples: {
      past: { cz: "Odešel jsem z práce.", uk: "Я пішов з роботи." },
      future: { cz: "Odejdu brzy.", uk: "Я піду рано." },
      imperative: { cz: "Odejdi hned!", uk: "Йди геть негайно!" },
    },
  },
  {
    id: "uklizet",
    ...
    aspect: "imperfective",
    verbClass: "IV",
    present: { ja: "uklízím", ty: "uklízíš", on: "uklízí", my: "uklízíme", vy: "uklízíte", oni: "uklízejí" },
    pastParticiple: { m: "uklízel", f: "uklízela", n: "uklízelo", manim_pl: "uklízeli", other_pl: "uklízely" },
    imperative: { ty: "uklízej", vy: "uklízejte", my: "uklízejme" },
    aspectPairNote: "доконаний партнер: uklidit (прибрати)",
    aspectPairId: "uklidit",
    examples: {
      present: { cz: "Uklízím kuchyni.", uk: "Я прибираю кухню." },
      past: { cz: "Uklízel jsem kuchyni.", uk: "Я прибирав кухню." },
      future: { cz: "Budu uklízet kuchyni.", uk: "Я прибиратиму кухню." },
      imperative: { cz: "Uklízej kuchyni každý den!", uk: "Прибирай кухню щодня!" },
    },
  },
  {
    id: "uklidit",
    ...
    aspect: "perfective",
    verbClass: "IV",
    future: { ja: "uklidím", ty: "uklidíš", on: "uklidí", my: "uklidíme", vy: "uklidíte", oni: "uklidí" },
    pastParticiple: { m: "uklidil", f: "uklidila", n: "uklidilo", manim_pl: "uklidili", other_pl: "uklidily" },
    imperative: { ty: "ukliď", vy: "ukliďte", my: "ukliďme" },
    aspectPairNote: "недоконаний партнер: uklízet (прибирати)",
    aspectPairId: "uklizet",
    examples: {
      past: { cz: "Uklidil jsem kuchyni.", uk: "Я прибрав кухню." },
      future: { cz: "Uklidím kuchyni.", uk: "Я приберу кухню." },
      imperative: { cz: "Ukliď kuchyni!", uk: "Прибери кухню!" },
    },
  },
  {
    id: "prodavat",
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "prodávám", ty: "prodáváš", on: "prodává", my: "prodáváme", vy: "prodáváte", oni: "prodávají" },
    pastParticiple: { m: "prodával", f: "prodávala", n: "prodávalo", manim_pl: "prodávali", other_pl: "prodávaly" },
    imperative: { ty: "prodávej", vy: "prodávejte", my: "prodávejme" },
    aspectPairNote: "доконаний партнер: prodat (продати); природний антонім до koupit/kupovat",
    aspectPairId: "prodat",
    examples: {
      present: { cz: "Prodávám auto.", uk: "Я продаю авто." },
      past: { cz: "Prodával jsem auto.", uk: "Я продавав авто." },
      future: { cz: "Budu prodávat auto.", uk: "Я продаватиму авто." },
      imperative: { cz: "Prodávej rychle!", uk: "Продавай швидко!" },
    },
  },
  {
    id: "prodat",
    ...
    aspect: "perfective",
    verbClass: "V",
    future: { ja: "prodám", ty: "prodáš", on: "prodá", my: "prodáme", vy: "prodáte", oni: "prodají" },
    pastParticiple: { m: "prodal", f: "prodala", n: "prodalo", manim_pl: "prodali", other_pl: "prodaly" },
    imperative: { ty: "prodej", vy: "prodejte", my: "prodejme" },
    aspectPairNote: "недоконаний партнер: prodávat (продавати); той самий тип, що dát→dej",
    aspectPairId: "prodavat",
    examples: {
      past: { cz: "Prodal jsem auto.", uk: "Я продав авто." },
      future: { cz: "Prodám auto.", uk: "Я продам авто." },
      imperative: { cz: "Prodej mi to auto!", uk: "Продай мені те авто!" },
    },
  },
  {
    id: "stihat",
    ...
    aspect: "imperfective",
    verbClass: "V",
    present: { ja: "stíhám", ty: "stíháš", on: "stíhá", my: "stíháme", vy: "stíháte", oni: "stíhají" },
    pastParticiple: { m: "stíhal", f: "stíhala", n: "stíhalo", manim_pl: "stíhali", other_pl: "stíhaly" },
    imperative: { ty: "stíhej", vy: "stíhejte", my: "stíhejme" },
    aspectPairNote: "доконаний партнер: stihnout (встигнути)",
    aspectPairId: "stihnout",
    examples: {
      present: { cz: "Stíhám autobus.", uk: "Я встигаю на автобус." },
      past: { cz: "Stíhal jsem autobus.", uk: "Я встигав на автобус." },
      future: { cz: "Budu stíhat autobus.", uk: "Я встигатиму на автобус." },
      imperative: { cz: "Stíhej to!", uk: "Встигай це!" },
    },
  },
  {
    id: "stihnout",
    ...
    aspect: "perfective",
    verbClass: "II",
    future: { ja: "stihnu", ty: "stihneš", on: "stihne", my: "stihneme", vy: "stihnete", oni: "stihnou" },
    pastParticiple: { m: "stihl", f: "stihla", n: "stihlo", manim_pl: "stihli", other_pl: "stihly" },
    imperative: { ty: "stihni", vy: "stihněte", my: "stihněme" },
    aspectPairNote: "недоконаний партнер: stíhat (встигати)",
    aspectPairId: "stihat",
    examples: {
      past: { cz: "Stihl jsem autobus.", uk: "Я встиг на автобус." },
      future: { cz: "Stihnu autobus.", uk: "Я встигну на автобус." },
      imperative: { cz: "Stihni to!", uk: "Встигни це!" },
    },
  },
  {
    id: "verit",
    ...
    aspect: "imperfective",
    verbClass: "IV",
    present: { ja: "věřím", ty: "věříš", on: "věří", my: "věříme", vy: "věříte", oni: "věří" },
    pastParticiple: { m: "věřil", f: "věřila", n: "věřilo", manim_pl: "věřili", other_pl: "věřily" },
    imperative: { ty: "věř", vy: "věřte", my: "věřme" },
    aspectPairNote: "самостійне (без пари в активному вжитку); стійкий вираз «věř nevěř» (хоч вір, хоч ні)",
    examples: {
      present: { cz: "Věřím ti.", uk: "Я вірю тобі." },
      past: { cz: "Věřil jsem ti.", uk: "Я вірив тобі." },
      future: { cz: "Budu ti věřit.", uk: "Я віритиму тобі." },
      imperative: { cz: "Věř mi!", uk: "Вір мені!" },
    },
  },
  {
    id: "narodit-se",
    ...
    verbClass: "IV",
    reflexive: "se",
    future: { ja: "narodím", ty: "narodíš", on: "narodí", my: "narodíme", vy: "narodíte", oni: "narodí" },
    pastParticiple: { m: "narodil", f: "narodila", n: "narodilo", manim_pl: "narodili", other_pl: "narodily" },
    imperative: { ty: "naroď se", vy: "naroďte se", my: "naroďme se" },
    aspectPairNote: "самостійне (без пари в активному вжитку); наказовий спосіб рідковживаний (вживається переважно у побажаннях)",
    examples: {
      past: { cz: "Narodil jsem se v Praze.", uk: "Я народився в Празі." },
      future: { cz: "Narodí se v květnu.", uk: "Він народиться у травні." },
