...
export const GRAMMAR_TOPICS: GrammarTopic[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: "list",
        items: [
          { term: "Чол. істот. → як родовий", note: "vidím velkého muže, mám mladého bratra — знахідний однини збігається з родовим (-ého)." },
          { term: "Чол. неістот. → як називний", note: "vidím velký dům, mám mladý strom — знахідний однини не змінюється, лишається як у називному (-ý)." },
        ],
      },
      {
        type: "tip",
      ...
      {
        type: "tip",
        text: "💡 Перед суфіксом -ší (і рідше -ější) кінцевий приголосний основи часто чергується — той самий принцип, що й у називному множини чол. істот. (див. вище): k→č (hezký→hezčí, měkký→měkčí), h→ž (drahý→dražší, ubohý→ubožejší), ch→š (tichý→tišší). Якщо основа закінчується на -tý/-dý/-ný — приголосний зазвичай не чергується (mladý→mladší).",
      },
      {
        type: "tip",
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "tip",
        text: "💡 Виняток для «ty» (2 особи однини): «jsi» + se/si стягується в ОДНЕ слово — ses/sis. «učil ses», «vzpomínal sis» — це і є кодифікована норма (не розмовне спрощення!), а повна форма «učil jsi se» досі офіційно некодифікована, хоч і часто трапляється усно. Для «já/vy» (jsem/jste) такого стягнення нема — лишається «jsem se», «jste se».",
      },
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { term: "mě vs mně", note: "У родовому і знахідному (2. і 4.) — mě (2 літери), у давальному і місцевому (3. і 6.) — mně (3 літери). Підказка: підстав «Pepa» — Pepu → mě, Pepovi → mně." },
          { term: "Форми після прийменника (3-тя особа)", note: "У він/вона/воно/вони після прийменника початкове j- переходить у м'яке n-: jemu → k němu, jí → s ní, jich → od nich, je → na ně. Це м'яке n традиційно називають «ň», але окремої літери з гачком тут ніколи не буде — перед ě/í/i м'якість n передається самим написанням (němu, ní, nich, ně), тому в прикладах бачиш звичайне n. Без прийменника — j-форма (znám ho), з прийменником — n-форма (jdu k němu)." },
          { term: "ji vs jí (вона)", note: "Знахідний — ji (короткий i): Vidím ji. Решта відмінків (родовий/давальний/місцевий/орудний) — jí (довгий í): bez ní, s ní. Після прийменника скрізь ní." },
          { term: "Зворотний se/si", note: "Не має називного відмінка (1.) взагалі. se — знахідний (myji se), si — давальний (koupím si). Стосується підмета: Dívám se = дивлюсь на себе/просто дивлюся." },
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "paragraph",
        text: "Тільки jeden, dva і oba змінюються за родом. jeden / jedna / jedno (чол. / жін. / сер.). dva (чол.) — але dvě (жін. і сер.): dva muži, dvě ženy, dvě auta. Слово oba (обидва) поводиться точно так само, як dva: oba (чол.) — obě (жін. і сер.): oba bratři, obě sestry, obě auta. Числівники tři, čtyři та 5+ за родом не змінюються.",
      },
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "tip",
        text: "💡 Коли місяць названий СЛОВОМ — обидва в родовому: «čtrnáctého února». Але якщо місяць позначений числом, усталена практика (за рекомендацією Інституту чеської мови): день у родовому, а місяць-число в називному — «čtrnáctého druhý» — щоб уникнути плутанини двох однакових закінчень.",
      },
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: "list",
        items: [
          { term: "де? → vlevo, nahoře, venku…", note: "Auto je vlevo. (авто ліворуч)" },
          { term: "куди? → doleva, nahoru, ven…", note: "Zahni doleva. (поверни ліворуч)" },
          { term: "звідки? → zleva, shora, zvenku…", note: "Přišel zleva. (він прийшов зліва)" },
        ],
      },
      {
        type: "tip",
        text: "💡 Помічник (не правило без винятків!): БІЛЬШІСТЬ «куди?»-форм починаються на до- (doleva, dolů, dovnitř, doprostřed), а БІЛЬШІСТЬ «звідки?»-форм — на з-/зе- (zleva, zdola, zevnitř, zprostřed). Але є явні винятки: nahoru, ven, sem (куди? без до-); shora, odtud, odtamtud (звідки? без з-). Орієнтир корисний, та не запам'ятовуй його як стовідсоткове правило.",
      },
      ...
      {
        type: "tip",
        text: "💡 «tam» (там) — ОДНЕ слово одразу і для «де?», і для «куди?»: «Jsem tam» (я там) і «Jdu tam» (я йду туди) звучать однаково. А от «звідки?» — усе ж окреме слово: odtamtud. Для порівняння «тут» має повну трійку: tady / sem / odtud — там, де tam зливає дві форми в одну, tady їх розрізняє.",
      },
      {
        type: "tip",
        text: "💡 «doma» (вдома) / «domů» (додому) — пара де/куди звичайна, а от форми «звідки?» одним словом немає: вживається прийменникова конструкція «z domova» (родовий відмінок іменника domov), не самостійний прислівник.",
      },
      {
        type: "tip",
